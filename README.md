...
| Category       | Tools                                                                                                                                                                                                                                                                                                                                                                        |
| -------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Developer**  | [JSON Formatter](https://toolzip.xyz/developer-tools/json-formatter), [Regex Tester](https://toolzip.xyz/developer-tools/regex-tester), [UUID Generator](https://toolzip.xyz/developer-tools/uuid-generator), [JWT Decoder](https://toolzip.xyz/developer-tools/jwt-decoder), [Cron Generator](https://toolzip.xyz/developer-tools/cron-generator), [Hash Generator](https://toolzip.xyz/developer-tools/hash-generator) |
